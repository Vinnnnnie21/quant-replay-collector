...
python scripts/clean_release.py --output dist/QuantReplayCollector-v1.5.1-Clean
python scripts/check_release_clean.py dist/QuantReplayCollector-v1.5.1-Clean
```
