...
FEATURE_DEFINITIONS = [
    ...
    FeatureDefinition("volume_ratio_50", "volume", "Event volume divided by preceding mean volume.", "volume/mean(pre_volume_50)", "50 pre bars"),
    ...
    FeatureDefinition("volume_percentile_50", "volume", "Event volume percentile rank versus prior volume.", "percentile_rank(volume,pre_volume_50)", "50 pre bars"),
