...
@pytest.mark.parametrize(
    ...
    [
        ...
        "data/research_snapshots/snapshot-1/export_manifest.json",
...
def test_release_clean_check_rejects_symbolic_links(tmp_path, monkeypatch):
    ...
    assert inspect_release(release) == [
        ("linked.txt", "symbolic link is not allowed in a release")
    ]
